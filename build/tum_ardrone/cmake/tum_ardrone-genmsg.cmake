...
set(MSG_I_FLAGS "-Itum_ardrone:/home/cdio/cdio_ws/src/tum_ardrone/msg;-Istd_msgs:/opt/ros/indigo/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/cdio/cdio_ws/src/tum_ardrone/msg/filter_state.msg" NAME_WE)
add_custom_target(_tum_ardrone_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "tum_ardrone" "/home/cdio/cdio_ws/src/tum_ardrone/msg/filter_state.msg" "std_msgs/Header"
)

get_filename_component(_filename "/home/cdio/cdio_ws/src/tum_ardrone/srv/SetStayWithinDistance.srv" NAME_WE)
add_custom_target(_tum_ardrone_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "tum_ardrone" "/home/cdio/cdio_ws/src/tum_ardrone/srv/SetStayWithinDistance.srv" ""
)

get_filename_component(_filename "/home/cdio/cdio_ws/src/tum_ardrone/srv/SetStayTime.srv" NAME_WE)
add_custom_target(_tum_ardrone_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "tum_ardrone" "/home/cdio/cdio_ws/src/tum_ardrone/srv/SetStayTime.srv" ""
)

get_filename_component(_filename "/home/cdio/cdio_ws/src/tum_ardrone/srv/SetMaxControl.srv" NAME_WE)
add_custom_target(_tum_ardrone_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "tum_ardrone" "/home/cdio/cdio_ws/src/tum_ardrone/srv/SetMaxControl.srv" ""
)

get_filename_component(_filename "/home/cdio/cdio_ws/src/tum_ardrone/srv/SetReference.srv" NAME_WE)
add_custom_target(_tum_ardrone_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "tum_ardrone" "/home/cdio/cdio_ws/src/tum_ardrone/srv/SetReference.srv" ""
)

get_filename_component(_filename "/home/cdio/cdio_ws/src/tum_ardrone/srv/SetInitialReachDistance.srv" NAME_WE)
add_custom_target(_tum_ardrone_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "tum_ardrone" "/home/cdio/cdio_ws/src/tum_ardrone/srv/SetInitialReachDistance.srv" ""
)
...
_generate_msg_cpp(tum_ardrone
  "/home/cdio/cdio_ws/src/tum_ardrone/msg/filter_state.msg"
  "${MSG_I_FLAGS}"
