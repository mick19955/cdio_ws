...
int main(int argc, char** argv)
{
	...
	//		do_instruction(hover,2);
		...
		//	State = Searching;
			...
			if ( circle_counter == 0) {
				do_instruction(forward, 1.2); //startup sequence
				...
				do_instruction(spin_left, 0.8);
				//do_instruction(hover, 1);
				//do_instruction(down_forward, 2);	
				do_instruction(down, 1.2);
				do_instruction(forward, 0.);	
